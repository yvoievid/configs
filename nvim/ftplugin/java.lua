...
vim.list_extend(bundles, vim.split(vim.fn.glob(vim.env.HOME .. "/.local/share/nvim/mason/share/java-debug-adapter/com.microsoft.java.debug.plugin.jar", 1), "\n"))
...
local config = {
  ...
  settings = {
    java = {
      ...
      home = '/Library/Java/JavaVirtualMachines/temurin-22.jdk/Contents/Home',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-22",
            path = "/Library/Java/JavaVirtualMachines/temurin-22.jdk/Contents/Home"
          },
          {
            name = "JavaSE-1.8",
